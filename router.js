...
apiRouter.get("/", (req, res) => res.json("Hello, if you see this message boy that means your backend is up and running successfully. Congrats! Now let's continue learning React!"))
